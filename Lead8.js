...
const questionId = "leadership_q8";

// ===============================
// CORRECT ANSWER
// ===============================

const correctAnswer = "support";
...
if (missionSnap.exists()) {
  ...
  if (data.completed === true) {
    ...
    analysisText.textContent =
      "✅ Emotional Intelligence Decision Already Recorded";
...
console.error(
  "Lead Mission 8 Previous Answer Error:",
  error
);
...
setTimeout(async function () {
  ...
  try {
    ...
    if (isCorrect) {
      ...
      analysisText.textContent =
        "✅ Excellent! Understanding and supporting your team is strong emotional intelligence.";
