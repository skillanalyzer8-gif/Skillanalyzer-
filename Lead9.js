...
const questionId = "leadership_q9";
...
if (missionSnap.exists()) {
  ...
  if (data.completed === true) {
    ...
    analysisText.textContent =
      "✅ Crisis Command Decision Already Recorded";
...
console.error(
  "Lead Mission 9 Previous Answer Error:",
  error
);
...
analysisText.textContent =
  "🤖 AI Crisis Commander is analyzing your decision...";
...
setTimeout(async function () {
  ...
  analysisText.textContent =
    "🤖 Recording your crisis-command decision...";
  ...
  try {
    ...
    if (isCorrect) {
      ...
      analysisText.textContent =
        "✅ Excellent! You took decisive action while keeping communication with the client.";
...
alert(
  "Please wait until your crisis-command decision is saved."
);
